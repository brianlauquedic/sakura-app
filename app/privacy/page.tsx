  ...
  en: {
    ...
    sections: [
      ...
      },
      {
        ...
        subsections: [
          ...
          },
          {
            ...
            items: [
              "AI analysis logs – wallet addresses submitted to Shielded Lending scans, strategy descriptions submitted for cross-protocol routing, and lending position data queried via Shielded Lending.",
              "AI-generated outputs – Claude AI security reports (SHA-256 hashed and recorded on Solana), cross-protocol routing simulation results, and ZK-rescue logs. On-chain Memo records are permanently public.",
            ],
          },
          {
      ...
      },
      {
        ...
        items: [
          "Deliver AI analysis – Shielded Lending position scans, cross-protocol rescue simulations, and ZK-verified rescue operations powered by Claude AI.",
          "Blockchain data retrieval – querying Helius RPC and Solana program accounts to fetch on-chain data required for Shielded Lending position scans, cross-protocol rescue simulations, and Shielded Lending health factor monitoring.",
      ...
      },
      {
        ...
        subsections: [
          { title: "Infrastructure and service providers", body: "We share data with hosting, analytics, and security vendors under strict data processing agreements. This includes Helius (Solana RPC for on-chain data), Claude AI (Anthropic) for AI security reports and strategy parsing, Jupiter (DEX aggregator for cross-protocol rescue execution), and Solana Agent Kit (SAK) for on-chain transaction execution." },
          { title: "Blockchain data", body: "Your public wallet address is used to query the Solana blockchain. Blockchain data is inherently public. Sakura writes to the blockchain on your behalf only during cross-protocol rescue execution (with your explicit confirmation) and ZK-verified rescue (within your pre-authorized SPL Token Approve spending cap). SHA-256 hashes of AI reports are permanently recorded via Solana Memo Program and are publicly visible." },
  ...
  zh: {
    ...
    sections: [
      ...
      },
      {
        ...
        subsections: [
          ...
          },
          {
            title: "2.2 AI 互動資料",
            items: [
              "AI 分析日誌——提交給 Shielded Lending 的錢包地址、提交給 cross-protocol routing 的策略描述，以及 Shielded Lending 查詢的借貸倉位資料。",
              "AI 生成輸出——Claude AI 安全報告（SHA-256 哈希記錄在 Solana 鏈上）、cross-protocol routing 模擬結果及 Shielded Lending 救援日誌。鏈上 Memo 記錄永久公開可見。",
            ],
          },
          {
            title: "2.3 使用及技術資料",
      ...
      },
      {
        ...
        items: [
          "提供 AI 分析——包括 Shielded Lending 安全報告、cross-protocol routing 策略模擬及 Shielded Lending 救援操作，均由 Claude AI 驅動。",
          "區塊鏈資料獲取——查詢 Helius RPC 及 Solana 程序賬戶，獲取 Shielded Lending 掃描、cross-protocol routing 模擬及 Shielded Lending 健康因子監控所需的鏈上資料。",
      ...
      },
      {
        ...
        subsections: [
          { title: "基礎設施及服務提供商", body: "我們在嚴格的資料處理協議下與供應商共享資料，包括 Helius（Solana RPC 鏈上資料）、Claude AI（Anthropic，AI 安全報告與策略解析）、Jupiter（DEX 聚合器，cross-protocol routing 執行）及 Solana Agent Kit（SAK，鏈上交易執行）。" },
          { title: "區塊鏈資料", body: "您的公開錢包地址用於查詢 Solana 區塊鏈。區塊鏈資料本質上是公開的。Sakura 僅在以下情況代您寫入區塊鏈：cross-protocol routing 執行（需您明確確認）及 Shielded Lending 救援（在您預授權的 SPL Token Approve 支出上限內）。AI 報告的 SHA-256 哈希透過 Solana Memo Program 永久上鏈，永久公開可見。" },
